...
Anstatt RStudio und R lokal auf dem eigenen Rechner zu installieren, kann man eine zentrale Installation auf einem Srever verwenden. Mehrere Benutzer können dann die Installation gemeinsam nutzen, in dem Sie über einen Webbrowser
darauf zugreifen. Dabei hat jeder Benutzer seinen eigenen Bereich.

Das Projekt [bwJupyter](https://www.bwjupyter.de/) des KIT stellt einen solchen RStudio-Server (und weitere Resourcen) zentral für die Lehre an baden-württembergischen
Hochschulen bereit.

Sie finden den Server hier:

<a href="https://hub.bwjupyter.de/"><tt><span style="color:darkgray">https://hub.bwjupyter.de/</u></b></tt></a>

Anleitung zum Einloggen:

- Geben Sie in Ihrem Webbrowser die Adresse ein: [hub.bwjupyter.de](https://hub.bwjupyter.de)

- Klicken Sie auf "Anmelden mit bwIDM"

- Geben Sie im Textfeld "Heidelberg" ein und wählen Sie "Universität Heidelberg". Klicken Sie dann auf "Weiter"

- Geben Sie ihre UniID (im Format "xy123") und Ihr Passwort ein

- Akzeptieren Sie ggf. die Datenübetragung

- Scrollen Sie nach unten (!) zur Box "**bwJupyter - RStudio**" und klicken Sie dort auf "Start"
