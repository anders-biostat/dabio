# Tidyverse: Reduktion mit group_by und summarise

### Einführendes Beispiel

Wir beginnen nochmals mit der Beispiel-Tabelle vom vorigen Abschnitt
...
Was ist das mittlere Gewicht der Wühlmäuse in den beiden Waldgebieten? Der folgende Code beantwortet diese Frage:
...
Nun berechnen wir die Mordrate pro Region, indem wir zunächst Bevölkerung und Fallzahlen nach Regionen getrennt aufaddieren und dann eine Spalte mit dem Verhältnis hinzufügen.
...
<div class="imp">Abtasten einer Tidyverse-Pipeline: Wenn Sie verstehen wollen, wie der vorstehende Code funktioniert, führen Sie ihn Schritt für Schritt aus, indem Sie zunehmend größere Teile des Codes markieren, immer vom Anfang bis direkt *vor* ein Pipe-Symbol `%>%`, und führen Sie diesen Code aus. So sehen Sie, wie die Tabellen mit Zwischenergebnissen aussehen, die durch das Pipe-Symbol geschoben werden. </div>

### Aufgabe zur NHANES-Tabelle: mittlere Körpergröße

Was ist die mittlere Körpergröße der erwachsenen Männer und Frauen im NHANES-Datensatz?
...
Hier mussten wir `na.rm=TRUE` anfügen, um dafür zu sorgen, dass fehlende Werte übersprungen werden. Die erklären wir nun:
